...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = ADC_TEMP_PLUSE_Pin|ADC_TEMP_MINUS_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(GPIOC, ADC_TEMP_PLUSE_Pin|ADC_TEMP_MINUS_Pin|ADC_3V_BATTERY_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = PWM_MX489_DI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(PWM_MX489_DI_GPIO_Port, &GPIO_InitStruct);
