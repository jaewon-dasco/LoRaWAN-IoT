...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = ADC_3V_BATTERY_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_3V_BATTERY_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(ADC_3V_BATTERY_GPIO_Port, ADC_3V_BATTERY_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PC1     ------> LPUART1_TX
    */
    GPIO_InitStruct.Pin = LPUART1_USB_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_LPUART1;
    HAL_GPIO_Init(LPUART1_USB_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = LPUART1_USB_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_LPUART1;
    HAL_GPIO_Init(LPUART1_USB_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    */
    GPIO_InitStruct.Pin = UART1_EXTCOM_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(UART1_EXTCOM_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = UART1_EXTCOM_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(UART1_EXTCOM_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = UART1_EXTCOM_DE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(UART1_EXTCOM_DE_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PC5     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = UART3_LORA_TX_Pin|UART3_LORA_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PC1     ------> LPUART1_TX
    */
    HAL_GPIO_DeInit(GPIOC, LPUART1_USB_RX_Pin|LPUART1_USB_TX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB3 (JTDO-TRACESWO)     ------> USART1_DE
    */
    HAL_GPIO_DeInit(GPIOA, UART1_EXTCOM_TX_Pin|UART1_EXTCOM_RX_Pin);

    HAL_GPIO_DeInit(UART1_EXTCOM_DE_GPIO_Port, UART1_EXTCOM_DE_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC5     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, UART3_LORA_TX_Pin|UART3_LORA_RX_Pin);
